...
static const CGFloat CSToastVerticalPadding     = 9.5;
static const CGFloat CSToastLeftImagePadding    = 8.0;
...
// display duration
static const NSTimeInterval CSToastDefaultDuration  = 0.65;

// image view size
static const CGFloat CSToastImageViewWidth      = 12.0;
static const CGFloat CSToastImageViewHeight     = 12.0;
...
- (void)makeToast:(NSString *)message backgroundColor:(UIColor *)backgroundColor image:(UIImage *)image {
      ...
      tapCallback:(void(^)(void))tapCallback
{
  ...
  toast.tag = CURRENT_TOAST_TAG;
  
  UIView *currentToast = [self viewWithTag:CURRENT_TOAST_TAG];
  if (currentToast != nil) {
...
- (CGPoint)centerPointForPosition:(id)point withToast:(UIView *)toast {
  ...
  // default to bottom
  return CGPointMake(self.bounds.size.width/2, self.bounds.size.height/3*2);
}
...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
  ...
  wrapperView.backgroundColor = [[UIColor colorWithRed:0.510 green:0.506 blue:0.494 alpha:1.000] colorWithAlphaComponent:CSToastOpacity];
  
  if(image != nil) {
    imageView = [[UIImageView alloc] initWithImage:image];
    imageView.contentMode = UIViewContentModeScaleAspectFit;
    imageView.frame = CGRectMake(CSToastHorizontalPadding, CSToastVerticalPadding+2, CSToastImageViewWidth, CSToastImageViewHeight);
  }
  ...
  if(imageView != nil) {
    ...
    imageLeft = CSToastLeftImagePadding;
  } else {
  ...
  if (title != nil) {
    ...
    titleLabel.textColor = [UIColor colorWithRed:0.980 green:0.973 blue:0.957 alpha:1.000];
  ...
  if (message != nil) {
    ...
    messageLabel.textColor = [UIColor colorWithRed:0.980 green:0.973 blue:0.957 alpha:1.000];
